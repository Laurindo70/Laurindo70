...
<img src="./images/Data extraction-amico.svg" min-width="400px" max-width="400px" width="400px" align="right" alt="Computador com dados">

<p align="left">Hello, my name is <strong>Ronan Laurindo</strong>, I am <strong>Full-stack Developer</strong>.</p>

<p align="left">
  🎓 Trainings: <strong>Bachelor's Degree in Software Engineering</strong> and <strong>Technical Course in Computer Science for the Internet</strong>
</p>
<p align="left">
  🛠️ Languages: <strong>JavaScript, C#, PHP</strong>
</p>
<p align="left">
  🛠️ Back-End & Database: <strong>Dotnet, Node.js, Express, Laravel, MySQL, PostgreSQL, MongoDB, Firebase</strong>
</p>
<p align="left">
  🎨 Front-End: <strong>React, Next.js, Vue, Nuxt.js, HTML5, CSS3</strong>
</p>
<p align="left">
